...
summary(model1)	#yields a set of univariate analyses, assumes that you will go through variable by variable instead of multivariate data
...
#Also in vegan (FRPP only) (in the Y, give a distance matrix or tell it what variable to do a distance matrix on it.)
